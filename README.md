# A demo implementation of a web tetris score system using .NET 5, ASP.NET Core MVC, Razor Pages, SignalR, bootstrap 4.3.1, EF Core 5.0.12, SQL Server 2018, which supports:
